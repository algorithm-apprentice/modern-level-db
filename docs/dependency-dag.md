...
| `implement-wal-io` | Owned WAL stream reader/writer with logical reassembly, corruption events, initial offsets, flush, sync, and close | `implement-platform-fs`, `implement-wal-format` |
