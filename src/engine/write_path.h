...
[[nodiscard]] Status PrepareGroup(WriteBatch& group, SequenceNumber first_sequence);
...
[[nodiscard]] Status CommitGroup(const WriteBatch& group, bool sync, WalWriter& log,
                                 MemTable& memtable);
